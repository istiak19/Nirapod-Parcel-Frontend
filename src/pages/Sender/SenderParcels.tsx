...
const SenderParcels = () => {
    const { data: parcels, isLoading } = useGetMeParcelQuery(undefined);
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    Swal.fire("Error!", err?.data?.message || "Failed to cancel parcel.", "error");
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            <Button
                                                ...
                                                disabled={parcel.currentStatus === "Dispatched" || parcel.currentStatus === "In Transit" || parcel.currentStatus === "Delivered" || parcel.currentStatus === "Cancelled"} className="cursor-pointer"
                                                    ...
                                                    <p className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                                        ...
                                                        {log.updateAt && (
                                                            <span className="ml-2 text-xs text-gray-500">
                                                                {format(
                                                                    new Date(log?.updateAt ? log?.updateAt : new Date()),
                                                                    "PPP p"
                                                                )}
                                                            </span>
                                                        )}
